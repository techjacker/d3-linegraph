module.exports = function(grunt) {
	...
	var docsTmplDir = 'docs-tmpl',
		...
		filesWatch = filesTestLib.concat(['test/index.html', 'Gruntfile.js', 'component.json', filesDocsTmpl, filesData, filesCSS]),
	...
	grunt.initConfig({
		...
		notify_hooks: {
			options: {
				...
				title: "d3-linegraph" // defaults to the name in package.json, or uses project's directory name, you can change to the name of your project
			}
		},
